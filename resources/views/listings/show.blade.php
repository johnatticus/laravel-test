<x-layout>
    ...
    <div class="mx-4">
        ...
        <x-card class="mt-4 p-2 flex space-between-x-6">
            <a href="/listings/{{$listing->id}}/edit" class="bg-laravel text-white py-2 px-4 mr-2 rounded hover:opacity-80">
            ...
            <form method="POST" action="/listings/{{$listing->id}}">
                @csrf
                @method('DELETE')
                <button class="bg-laravel text-white py-2 px-4 rounded hover:opacity-80"><i class="fa-solid fa-trash"></i> Delete</button>
              </form>
        </x-card>
    </div>
</x-layout>